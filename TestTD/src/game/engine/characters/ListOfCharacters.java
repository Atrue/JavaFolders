...
public class ListOfCharacters {
	...
	private static void initTowers(){
		...
		towers[6][0] = new Tower(44, 4.5, 0.3, 90, 450, 1, 6, Color.color(0.7,0.7, 0), null);
		towers[6][1] = new Tower(196, 4.5, 0.28, 95, 1755, 2, 6, Color.color(0.7, 0.7, 0), null);
		towers[6][2] = new Tower(972, 4.5, 0.26, 100, 6669, 3, 6, Color.color(0.7, 0.7, 0), null);
		towers[6][3] = new Tower(4444, 4.5, 0.24, 105, 24675, 4, 6, Color.color(0.7, 0.7, 0), null);
		towers[6][4] = new Tower(13579, 4.5, 0.2, 110, 86363, 5, 6, Color.color(0.7, 0.7, 0), null);
		
	}
	private static void initMonsters(){
		monsters[0] = new Monster(2, 1.0, 1, 0);
		monsters[1] = new Monster(1.34, 1.5, 1.1, 1);
		monsters[2] = new Monster(3.5, 0.8, 1.5, 2);
	}
